      ...
      <div className="dashboard-grid">
        ...
        <Card className="shadow-lg  col-span-2">
          ...
          <div className="mt-4 flex justify-between items-center">
            <div
              className={`px-3 py-1.5 rounded-lg ${remainingCalories >= 0 ? "bg-emerald-50 dark:bg-amber-900/10 text-emerald-700 dark:text-emerald-400" : "bg-emerald-50 dark:bg-red-900/10 text-red-700 dark:text-red-400"}`}
            >
        ...
        {/* Goal Card */}
          {/* if user is available then this card appear */}
          ...
          <Card className="bg-linear-to-r from-slate-800 to-slate-700">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center">
                <TrendingUpIcon  className="w-6 h-6 texts-emerald-400"/>
              </div>
              <div>
          ...
          <Card>
            <div className="flex items-center gap-4 mb-6">
              <div className="w-12 h-12 rounded-xl bg-indigo-100 flex items-center justify-center">
                <ScaleIcon  className="w-6 h-6 texts-indigo-500"/>
              </div>
              <div>
